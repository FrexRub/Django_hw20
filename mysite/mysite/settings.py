...
#Путь к базе данных, хранимых в файле (sqlite)
...
DEBUG = getenv("DJANGO_DEBUG", "0") == "1" # получаем значение и сравниваем с "1". Если "1", то режим отладки
...
# настройки для работы с DEBUG TOOLS
INTERNAL_IPS = [
    "127.0.0.1",
]
